...
namespace Naninovel
{
    ...
    public class LayeredActorBehaviourEditor : Editor
    {
        ...
        private static readonly GUIContent previewContent = new("Preview Composition");
        private static readonly GUIContent pasteContent = new("Paste Current Composition");
