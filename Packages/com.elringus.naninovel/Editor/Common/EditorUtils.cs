...
namespace Naninovel
{
    public static class EditorUtils
    {
        ...
        /// <summary>
        /// Checks whether asset with the specified GUID exists.
        /// </summary>
        ...
        /// <summary>
        /// Checks whether asset with the specified relative project asset path (`Assets/...`) exists.
        /// </summary>
        ...
        /// Will return null in case asset with the specified GUID doesn't exist.
        /// </summary>
        ...
        /// <summary>
        /// For the specified editor object, will assign all the readonly <see cref="SerializedProperty"/> fields with the references to the corresponding fields of the edited object
        ...
        public static void FolderField (SerializedProperty property, string title = default,
            string defaultPath = default, Func<string, string> transformPath = default)
        {
            PathField(property, (t, p) => EditorUtility.OpenFolderPanel(t, p, ""), title, defaultPath, transformPath);
        }

        public static void FileField (SerializedProperty property, string extension, string title = default,
            string defaultPath = default, Func<string, string> transformPath = default)
        {
            PathField(property, (t, p) => EditorUtility.OpenFilePanel(t, p, extension), title, defaultPath, transformPath);
        }

        public static void FileField (SerializedProperty property, string[] filters, string title = default,
            string defaultPath = default, Func<string, string> transformPath = default)
        {
            PathField(property, (t, p) => EditorUtility.OpenFilePanelWithFilters(t, p, filters), title, defaultPath, transformPath);
        }

        public static void PathField (SerializedProperty property, Func<string, string, string> openPanel,
            string title = default, string defaultPath = default, Func<string, string> transformPath = default)
        {
            ...
            if (GUILayout.Button("Select", EditorStyles.miniButton, GUILayout.Width(65)))
            {
                ...
                path = transformPath != null ? transformPath(path) : PathUtils.AbsoluteToAssetPath(path);
