...
namespace Naninovel
{
    ...
    {
        [SerializeField] private List<string> fieldValues = new();

        private readonly List<LineTextField> fields = new();
        private readonly HashSet<LineTextField> fieldsHash = new();
