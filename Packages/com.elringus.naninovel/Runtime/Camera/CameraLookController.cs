...
namespace Naninovel
{
    ...
    public class CameraLookController
    {
        ...
        private readonly IInputSampler xSampler;
        private readonly IInputSampler ySampler;
        ...
        public void Update ()
        {
            ...
            var offsetX = (xSampler?.Value ?? 0) * LookSpeed.x * Engine.Time.DeltaTime;
            var offsetY = (ySampler?.Value ?? 0) * LookSpeed.y * Engine.Time.DeltaTime;
