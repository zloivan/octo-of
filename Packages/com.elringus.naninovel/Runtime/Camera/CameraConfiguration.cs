...
namespace Naninovel
{
    ...
    public class CameraConfiguration : Configuration
    {
        ...
        public Vector3 InitialPosition = new(0, 0, -10);
        ...
        public Vector2Int ThumbnailResolution = new(240, 140);
        ...
        /// <summary>
        /// Converts specified relative scene position into world space based on the specified scene rect.
        /// </summary>
        ...
        public static Vector3 SceneToWorldSpace (Vector3 scenePosition, Rect sceneRect)
        {
            ...
            return new(resultXY.x, resultXY.y, scenePosition.z);
        }
        ...
        public static Vector3 WorldToSceneSpace (Vector3 worldPosition, Rect sceneRect)
        {
            ...
            return new(resultXY.x, resultXY.y, worldPosition.z);
        }
        ...
        protected virtual Rect EvaluateSceneRect ()
        {
            ...
            if (MatchScreenWidth)
            {
                ...
                resolution = new(width, ReferenceResolution.y);
            }
