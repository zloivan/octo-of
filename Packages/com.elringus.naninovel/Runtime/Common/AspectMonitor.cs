...
namespace Naninovel
{
    ...
    public class AspectMonitor
    {
        ...
        /// <param name="target">When specified and becomes invalid, monitoring will automatically stop.</param>
        public void Start (float updateDelay = .5f, UnityEngine.Object target = default, AsyncToken token = default)
        {
            timer.Run(updateDelay, true, true, token, target);
        }
