...
namespace Naninovel
{
    public static class EventUtils
    {
        ...
        public static GameObject GetHoveredGameObject ()
        {
            ...
            data.position = UnityEngine.InputSystem.Touchscreen.current?.primaryTouch.press.wasPressedThisFrame ?? false
                ? UnityEngine.InputSystem.Touchscreen.current.primaryTouch.position.ReadValue()
