...
namespace Naninovel
{
    public static class LinqUtils
    {
        ...
        /// <summary>
        /// Clears the source collection and adds items from the specified enumerable.
        /// </summary>
        public static void ReplaceWith<T> (this ICollection<T> source, IEnumerable<T> from)
        {
            source.Clear();
