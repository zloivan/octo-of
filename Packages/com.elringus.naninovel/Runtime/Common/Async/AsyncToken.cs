...
namespace Naninovel
{
    ...
    /// </summary>
    /// <remarks>
    /// When the token is specified for an async method, implementation is expected to check for
    ...
    public readonly struct AsyncToken : IEquatable<AsyncToken>
    {
        ...
        /// <param name="completion">Whether the specified token is for completion.</param>
