...
namespace Naninovel
{
    ...
    {
        public static implicit operator NullableString (string value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableInteger (int value) => new() { Value = value };
        public static implicit operator int? (NullableInteger nullable) => nullable is null || !nullable.HasValue ? null : nullable.Value;
    }
    ...
    {
        public static implicit operator NullableFloat (float value) => new() { Value = value };
        public static implicit operator float? (NullableFloat nullable) => nullable is null || !nullable.HasValue ? null : nullable.Value;
    }
    ...
    {
        public static implicit operator NullableBoolean (bool value) => new() { Value = value };
        public static implicit operator bool? (NullableBoolean nullable) => nullable is null || !nullable.HasValue ? null : nullable.Value;
    }
    ...
    {
        public static implicit operator NullableVector2 (Vector2 value) => new() { Value = value };
        public static implicit operator Vector2? (NullableVector2 nullable) => nullable is null || !nullable.HasValue ? null : nullable.Value;
    }
    ...
    {
        public static implicit operator NullableVector3 (Vector3 value) => new() { Value = value };
        public static implicit operator Vector3? (NullableVector3 nullable) => nullable is null || !nullable.HasValue ? null : nullable.Value;
    }
    ...
    {
        public static implicit operator NullableVector4 (Vector4 value) => new() { Value = value };
        public static implicit operator Vector4? (NullableVector4 nullable) => nullable is null || !nullable.HasValue ? null : nullable.Value;
    }
    ...
    {
        public static implicit operator NullableQuaternion (Quaternion value) => new() { Value = value };
        public static implicit operator Quaternion? (NullableQuaternion nullable) => nullable is null || !nullable.HasValue ? null : nullable.Value;
    }
    ...
    {
        public static implicit operator NullableNamedString (NamedString value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableNamedInteger (NamedInteger value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableNamedFloat (NamedFloat value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableNamedBoolean (NamedBoolean value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableNamedVector2 (NamedVector2 value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableNamedVector3 (NamedVector3 value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableNamedVector4 (NamedVector4 value) => new() { Value = value };
    ...
    {
        public static implicit operator NullableNamedQuaternion (NamedQuaternion value) => new() { Value = value };
