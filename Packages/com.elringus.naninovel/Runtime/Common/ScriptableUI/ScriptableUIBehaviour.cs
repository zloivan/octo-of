...
namespace Naninovel
{
    ...
    public class ScriptableUIBehaviour : UIBehaviour
    {
        ...
        /// </summary>
        public virtual async UniTask ChangeVisibility (bool visible, float? duration = null, AsyncToken token = default)
        {
            ...
            var tween = new FloatTween(CanvasGroup.alpha, targetOpacity, new(fadeDuration, scale: !IgnoreTimeScale), SetOpacity);
            await fadeTweener.RunAwaitable(tween, token, this);
        }
        ...
        protected virtual bool SampleInputSystemNavigation ()
        {
            ...
            return UnityEngine.InputSystem.Gamepad.current is { } gamepad &&
                   ...
                   UnityEngine.InputSystem.Joystick.current is { } joystick &&
