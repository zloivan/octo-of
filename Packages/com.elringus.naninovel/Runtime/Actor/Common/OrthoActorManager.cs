...
namespace Naninovel
{
        ...
        where TConfig : OrthoActorManagerConfiguration<TMeta>
    {
        ...
        /// <summary>
        /// Changes specified actor y position so that it's bottom edge is aligned with the bottom of the scene.
        /// </summary>
        ...
        protected override async UniTask<TActor> ConstructActor (string actorId)
        {
