...
namespace Naninovel
{
    ...
    public class Live2DController : MonoBehaviour
    {
        ...
        public virtual void SetLookDirection (CharacterLookDirection lookDirection)
        {
            ...
            lookTarget.transform.position = lookDirection switch {
                CharacterLookDirection.Center => transform.position,
                CharacterLookDirection.Left => transform.position - new Vector3(10, 0),
                CharacterLookDirection.Right => transform.position + new Vector3(10, 0),
                _ => lookTarget.transform.position
            };
        }
