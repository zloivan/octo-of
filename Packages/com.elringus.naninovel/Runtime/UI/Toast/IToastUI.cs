namespace Naninovel.UI
{
    ...
    {
        /// <summary>
        /// Shows the UI with the specified text and (optionally) appearance and duration.
        ...
        void Show (LocalizableText text, string appearance = default, float? duration = default);
    }
}
