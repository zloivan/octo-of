...
namespace Naninovel
{
    ...
    {
        private static readonly HashSet<Func<string, string>> preprocessors = new();

        /// <summary>
        /// Executes all the added preprocessors in order on the specified input string and returns the resulting string.
        ...
        /// <summary>
        /// Adds the specified delegate as the input preprocessor.
        ...
        /// <summary>
        /// Removes the specified preprocessor from the preprocessors list.
        /// </summary>
