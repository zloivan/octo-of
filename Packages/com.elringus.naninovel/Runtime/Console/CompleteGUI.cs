...
namespace Naninovel
{
    ...
    {
        private struct Option : IEquatable<Option>
        {
            public string Label, MethodName;
            public bool Equals (Option other) => Label == other.Label && MethodName == other.MethodName;
            public override bool Equals (object obj) => obj is Option other && Equals(other);
            public override int GetHashCode () => HashCode.Combine(Label, MethodName);
        }
        ...
        private static string ExtractMethodName (string input)
        {
            ...
            return firstSpaceIndex > 0 ? trimmed[..(firstSpaceIndex - 1)] : trimmed;
        }
        ...
        private static Option BuildOption (string methodName, MethodInfo info)
        {
            ...
            return new() { Label = label, MethodName = methodName };
        }
